...
trait TaskTrait
{
    ...
    public function getPerIdLogin($id)
    {
        $data = DB::table('tasks')
    ...
    public function getByStatusAll()
    {
    ...
    {
        $data = Tk::select('id')->get()->count();
        return $data;
    }

    public function countAllTaskComplete()
    {

        $data = Tk::select('status')->where('status', 'Complete')->get()->count();
        return $data;
    }
