            ...
            <div class="row align-items-center">
                <div class="border-0 mb-4">
                    <div
                        ...
                        <h3 class="fw-bold mb-0">Historycal</h3>
                                            ...
                                            <td>
                                                @if ($list->status == 'Waiting')
                                                    ...
                                                    <span class="badge bg-primary"><i
                                                            class="icofont-stuck-out-tongue"></i></span>
                                                @elseif ($list->status == 'Approved')
                                                    <span class="badge bg-success">{{ __($list->status) }}</span>
                                                    <span class="badge bg-success"><i class="icofont-heart-eyes"></i></span>
                                                @else
                                                    <span class="badge bg-danger">{{ __($list->status) }}</span>
                                                    <span class="badge bg-danger"><i class="icofont-confused"></i></span>
                                                @endif
                                            </td>
                                            <td>{{ __($list->sd) }}</td>
                                            <td>{{ __($list->ed) }}</td>
            ...
            $("form[name='form-add-request']").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('leave_management_req_em') }}",
                        dataType: 'json',
                        cache: false,
                        type: 'POST',
                        data: {
                    ...
                    Swal.fire({
                        ...
                        if (e.value === true) {
                            ...
                            $.ajax({
                                ...
                                url: "{{ route('leave_management_update_em') }}",
                                dataType: 'json',
                                cache: false,
                                type: 'PUT',
                                data: {
