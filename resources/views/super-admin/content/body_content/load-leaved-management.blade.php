            ...
            Swal.fire({
                ...
                if (e.value === true) {
                    $.ajax({
                        ...
                        url: "{{ url('super-admin/leave/management/delete') }}" + '/' + id,
                        dataType: 'json',
                        type: 'DELETE',
                        cache: false,
                        data: {
            ...
            $("form[name='form-add-request']").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({ 
                        ...
                        url: "{{ route('leave_management_req_sa') }}",
                        dataType: 'json',
                        cache: false,
                        type: 'POST',
                        data: {
            ...
            $("form[name='form-edit-request']").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('leave_management_update_sa') }}",
                        dataType: 'json',
                        cache: false,
                        type: 'PUT',
                        data: {
