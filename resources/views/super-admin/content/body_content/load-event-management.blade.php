    ...
    <script type='text/javascript'>
            ...
            Swal.fire({
                ...
                if (e.value === true) {
                    $.ajax({
                        ...
                        url: "{{ url('super-admin/office/event/delete/') }}" + '/' + id, //Define Post URL
                        dataType: 'json',
                        type: "DELETE",
                        data: {
                            "_token": "{{ csrf_token() }}"
            ...
            $("form[name='form-add-event']").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('new_event_officer_sa') }}",
                        dataType: 'json',
                        cache: false,
                        type: 'POST',
                        data: {
        ...
        function update_event() {
            $("form[name='form-edit-event']").validate({
                ...
                messages: {
                    title1: "Please enter event title",
                    description1: "Please enter event descriptions",
                    start_date1: "Please enter start date",
                    end_date1: "Please enter end date",
                    type1: "Please enter event type",
                },
                submitHandler: function(form) {
                    var id = $("#id1").val();
